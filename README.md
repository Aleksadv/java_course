...
Исходный размер: 27176 байт
Сжатый размер: 17727 байт
Коэффициент сжатия: 0,65
Экономия: 34,8%
...
| test3.bin     | 27176 байт      | 17727 байт    | 0.65              | 35%      |
...
3. **test3.bin**: Хорошее сжатие (35%) на реальных данных благодаря алгоритму Хаффмана
